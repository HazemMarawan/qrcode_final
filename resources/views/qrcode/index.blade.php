    ...
    <div class="login">
      <div class="container">
        ...
        <div class="login-form">
          <form action="{{route('generate_qr_code')}}" method="get">
            <input name="qr_code_number" type="number" placeholder="Number of QR Codes">
            <input name="qr_code_message" type="text" placeholder="Welcome Message">
